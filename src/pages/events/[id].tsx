          ...
          <div className="max-w-4xl">
            ...
            <div className="space-y-4 text-lg leading-relaxed text-gray-50">
              <div className="flex items-center">
                ...
                <span className="font-semibold">{formatDateTime(event.startDate, event.timezone)}</span>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600">{formatDateTime(event.startDate, event.timezone)}</p>
                  </div>
