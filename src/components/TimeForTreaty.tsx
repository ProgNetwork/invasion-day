        ...
        <div className="text-gray-800">
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-gray-700">
              <p>
                <strong>First Nations peoples have been fighting for truth-telling and Treaties for generations.</strong>
                And right now, after decades of leadership and resistance, we are closer than ever to the first Treaty with First Nations people on this continent.
              </p>
              <p>
                Together, we can build unstoppable momentum for truth, Treaty and justice.
                <strong>This is our opportunity to move forward to a more just, fair and united future for everybody who calls these lands home.</strong>
              </p>
              <p>
