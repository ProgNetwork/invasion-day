    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-700">
          Can you share this pledge and encourage your family, friends and colleagues to show their support?
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            <svg className="w-8 h-8 mr-2 inline" fill="currentColor" viewBox="0 0 24 24">
