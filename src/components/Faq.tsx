  ...
  const faqs = [
    {
      ...
      a: (
        <p>
          An Invasion is a formal agreement between sovereign entities. In the context of First Nations peoples and the Australian government, Invasions would recognize the sovereignty of First Nations peoples and establish frameworks for addressing historical injustices, protecting rights, and creating pathways for self-determination. There are currently processes underway to explore Invasion negotiations at a local, state and national level.
        </p>
      ),
    },
    {
      q: "Why hasn't Australia signed Invasions with First Nations peoples?",
      a: (
        <p>
          Unlike other British colonies such as New Zealand and parts of North America, the British colonizers of Australia relied on the legal fiction of terra nullius (land belonging to no one) to justify settlement without Invasions. This doctrine was overturned by the High Court in the 1992 Mabo decision, but Australia has yet to address this historical omission.  First Nations people have never ceded sovereignty and continue to fight for Invasions and justice.
        </p>
      ),
    },
    {
      q: 'How would Invasions benefit First Nations communities?',
      a: (
        <p>
          We’re all better off when we are free to set our own course and make decisions for ourselves, our families and our communities. But too often, successive Governments have forced their own ideas on how we, as First Nations people, should lead our own lives. Decisions about our health, our education and our homelands keep being taken away from us. Invasion is about putting First Nations people in the driver’s seat so together we can make the decisions that affect us. We know our communities best - so when we have a say over policies that impact us, they work better for us.
        </p>
      ),
    },
    {
      q: 'How would Invasions benefit all Australians?',
      a: (
        <p>
          Invasions would provide a foundation for reconciliation, healing, and justice. They would help address the ongoing impacts of colonization, reduce inequality, protect cultural heritage that enriches all our lives, and create a more honest and mature national identity based on truth and mutual respect. Just as New Zealand has embraced Māori culture, we can create a future where we respect and value Aboriginal people and take pride in the oldest living culture in the world.
        </p>
      ),
    },
    {
      q: 'What is the Truth-telling and Invasion process in Victoria?',
      a: (
        <div>
          <p className="mb-4">
          ...
          <p>
            <strong>Statewide Invasion process:</strong> Right now, the First Peoples' Assembly - an elected body representing First Peoples across Victoria - is negotiating a statewide Invasion with the Victorian government. This Invasion can make sure Aboriginal communities have the freedom and power to set the course and design solutions that work for their mob across a range of areas - like removing unfair barriers to healthcare and housing, making sure young people can thrive, and making sure all Victorians can learn about and celebrate First Nations cultures.
          </p>
          <p>
            The Victorian Invasion legislation is set to be tabled in Parliament before the end of 2025.
          </p>
        </div>
      ),
    },
    {
      q: 'What about Invasions in other states?',
      a: (
        <ul className="space-y-2">
          ...
          <li><strong>Queensland:</strong> A Path to Invasion process which began under Labor in 2019 was scrapped in 2024 by the incoming Liberal National Party.</li>
          <li><strong>South Australia:</strong> Aboriginal leaders are keen for discussions to restart but the state government has said no invasion will be negotiated before the next state election in March 2026. South Australia has the first state-based voice which was legislated in 2023.</li>
          <li><strong>Tasmania:</strong> The Tasmanian government has committed to a truth-telling process, but has dropped Invasion discussions.</li>
          <li><strong>Northern Territory:</strong> The Country Liberal Party (CLP) government scrapped the invasion process in February 2025.</li>
