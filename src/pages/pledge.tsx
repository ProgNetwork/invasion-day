                  ...
                  {showSocialShare ? (
                    <>
                      <p className="text-lg text-gray-700 leading-relaxed mb-6">
                        We're just weeks away from Treaty legislation being introduced in Victoria. It will be the first Treaty with First Nations people in this country and is a critical step towards self-determination, justice and acknowledging the past.
                      </p>
                      <p className="text-lg text-gray-700 leading-relaxed">
                        But as the hard-right ramps up it's attacks, we need to make one thing clear: the community backs Treaty.
                      </p>
                    </>
                  ) : (
                    <>
