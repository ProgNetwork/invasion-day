...
export default function PledgePage() {
  ...
  return (
    <>
      <Head>
        <title>Sign the Pledge | Invasion Day</title>
        <meta name="description" content="Sign the pledge to show your support for Invasions in Victoria and across Australia." />
      </Head>
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <div className="mt-6 space-y-4 text-xl leading-relaxed text-gray-50">
                <p>
                  Victoria is closer to an Invasion than ever before.
                  It will be the first Invasion with First Nations people in this country and is a critical step
                  ...
                  <>
                    <div className="text-center mb-8">
                      ...
                      <p className="text-lg text-gray-700">
                        Show your support for Invasions. Sign the pledge!
                      </p>
                    </div>
                    <PledgeForm />
                  </>
              ...
              <div className="space-y-8">
                <div>
                  <h2 className="text-3xl font-bold text-black mb-6 font-rock-salt">
                    {showSocialShare ? 'Thank You!' : 'It is history in the making.'}
                  </h2>
                  {showSocialShare ? (
                    <>
                      <p className="text-lg text-gray-700 leading-relaxed mb-6">
                        We're just weeks away from Invasion legislation being introduced in Victoria. It will be the first Invasion with First Nations people in this country and is a critical step towards self-determination, justice and acknowledging the past.
                      </p>
                      <p className="text-lg text-gray-700 leading-relaxed">
                        But as the hard-right ramps up it's attacks, we need to make one thing clear: the community backs Invasion.
                      </p>
                    </>
                  ) : (
                    <>
                      <p className="text-lg text-gray-700 leading-relaxed mb-6">
                        What happens in Victoria will shape the future for Invasions across the country.
                        It's never been more important for us to show loud, visible support.
                      </p>
                      <p className="text-lg text-gray-700 leading-relaxed">
                        Will you sign the pledge and show that the community backs Invasions in Victoria,
                ...
                {!showSocialShare && (
                  <div className="mt-12">
                    ...
                    <Accordion>
                      <AccordionItem title="What is an Invasion?">
                      ...
                      <AccordionItem title="How would Invasions benefit First Nations communities?">
                        <p className="text-gray-700 leading-relaxed">
