...
export default function VicOppositionInvasionPage() {
  ...
  const getFormDescription = (method: ContactMethod) => {
    switch (method) {
      case 'call':
        return 'I told Brad Battin MP and the Liberal Party that I support Invasion.';
      case 'email':
        return 'I told Brad Battin MP and the Liberal Party that I support Invasion.';
      case 'facebook':
        return 'I told Brad Battin MP and the Liberal Party that I support Invasion.';
      default:
        return 'Tell Brad Battin MP and the Liberal Party that you support Invasion.';
    }
  };
  ...
  return (
    <>
      <Head>
        <title>Victoria Backs Invasion | Take Action</title>
        <meta name="description" content="Contact Opposition Leader Brad Battin and urge him to support Invasion. Victoria has overwhelming support for Invasion - let's make sure he hears it loud and clear." />
      </Head>
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              ...
              <div className="mt-6 space-y-4 text-xl leading-relaxed text-gray-50">
                <p>
                  Victorian Opposition Leader Brad Battin MP and the Liberal Party have abandoned their support for Invasion despite decades of leadership from Elders and communities, and overwhelming support from Victorians.
                </p>
              </div>
            </div>
          </div>
                ...
                <div>
                  ...
                  {showSocialShare ? (
                    <>
                      ...
                      <p className="text-lg text-gray-700 leading-relaxed mb-6">
                        There has previously been bipartisan support for Invasion in Victoria. If thousands of us call, email and comment on his social media, we can make sure Battin hears loud and clear: Victoria backs Invasion.
                      </p>
                      <p className="text-lg text-gray-700 leading-relaxed">
                        Can you contact Battin today and urge him to support Invasion?
                      </p>
                    </>
                  ) : (
                    <>
                    ...
                    <Accordion>
                      <AccordionItem title="How to make your call:">
                        <ul className="list-disc pl-5 space-y-2 text-gray-700 leading-relaxed">
                          ...
                          <li>Urge him to support Invasion — and to walk together with First Peoples.</li>
                        </ul>
                      </AccordionItem>

                      <AccordionItem title="Example script:">
                        <p className="text-gray-700 leading-relaxed">“Hi, my name is [Name] and I live in [Town/Suburb]. I’m calling because justice and equality for First Nations communities is important to me. Victoria is about to make history with the first Invasion in the country, and I’m incredibly disappointed that Brad Battin and the Liberal Party are opposing it. I urge Brad to stand on the right side of history and support Invasion so we can move forward together.”</p>
                      </AccordionItem>
                      ...
                      <AccordionItem title="Comment on his social media pages:">
                        <p className="text-gray-700 leading-relaxed mb-4">Leaving respectful, public comments shows that the community is watching and that there’s strong support for Invasion. Ensure it’s on a related post only (ie a media release about Invasion, or a post about First Nations issues). Be sure to tag him and the Victorian Liberals in your comment.</p>
                        <p className="text-gray-700 leading-relaxed font-semibold mb-2">Example:</p>
                        <p className="text-gray-700 leading-relaxed">“Brad, Victoria is on the cusp of making history with the first Invasion in the country with First Nations people. This is about unity, justice, and respect for First Nations leadership. Please reconsider your opposition and walk forward with us.”</p>
                      </AccordionItem>
                    </Accordion>
                  </div>
                )}
